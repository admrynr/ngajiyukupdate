...
<div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card m-b-20">
                    <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Input Product Form</h4>
                            <hr>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('store') }}">
            ...
            <div class="col-sm-10">
            <input name ="nampro" id="nampro" type="text" class="form-control">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input name="harpro" id="harpro" type="text" class="form-control">
